package com.example.baidumapsdk.demo.radar;
...
public class RadarDemo extends Activity implements RadarUploadInfoCallback,
    ...
    // 界面空间相关
    private com.example.com.example.baidumapsdk.Radar.CustomViewPager mPager; // 自定义viewPager，目的是禁用手势滑动
    ...
    private void initUI() {
        ...
        mPager = (com.example.com.example.baidumapsdk.Radar.CustomViewPager) findViewById(R.id.viewpager);
